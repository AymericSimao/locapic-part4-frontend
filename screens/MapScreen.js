...
import { addPlace, initial } from '../reducers/user';
...
export default function MapScreen() {
  ...
  async function handleNewPlace() {
    try {
      ...
      dispatch(addPlace({ name: newPlace, latitude: tempCoordinates.latitude, longitude: tempCoordinates.longitude })); //>> reducer remplacé par le fetch
